...
import { lessonWeekday, safeUrl, seatsStatus } from "../utils/format";
import {
  seatsLeft,
  totalSeats,
  registerForItem,
...
function SeatsRow({ kind, item, onRegister, extra }) {
...
function RegisterModal({ kind, item, onClose, onRegistered }) {
